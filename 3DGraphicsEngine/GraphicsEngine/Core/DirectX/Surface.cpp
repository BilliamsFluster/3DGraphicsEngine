...
Surface Surface::FromFile(const std::string& name)
{
...

	{
		...
		if (bitmap.GetLastStatus() != Gdiplus::Status::Ok)
		{
			...
			throw WinException(__LINE__, __FILE__, ss.str());
		}
...
Surface::WinException::WinException(int line, const char* file, std::string note) noexcept
	:
	Exception(line, file),
	note(std::move(note))
{}

const char* Surface::WinException::what() const noexcept
{
...
const char* Surface::WinException::GetType() const noexcept
{
	return "Graphics Exception";
}

const std::string& Surface::WinException::GetNote() const noexcept
{
	return note;
}